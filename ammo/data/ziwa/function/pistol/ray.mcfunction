particle minecraft:ominous_spawning ~ ~ ~ 0 0 0 0 1 force @a
...
execute positioned ^ ^ ^.0625 if block ~ ~ ~ #gunbreak run setblock ~ ~ ~ air destroy
execute unless block ^ ^ ^.0625 #gunpass run function ziwa:bullethole
execute unless entity @e[tag=gdamage,limit=1] if score @s rec matches ..399 positioned ^ ^ ^.0625 if block ~ ~ ~ #gunpass run function ziwa:pistol/ray