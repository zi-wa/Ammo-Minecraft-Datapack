...
execute as @e[tag=gdamage,limit=1] run function ziwa:shot/damage
...
execute unless entity @e[tag=gdamage,limit=1] if score @s rec matches ..79 positioned ^ ^ ^.125 if block ~ ~ ~ #gunpass run function ziwa:shot/ray