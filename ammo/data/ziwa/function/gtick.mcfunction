# pistol
execute as @a if score @s gtime matches 0 if score @s rclick matches 1.. if score @s ammo_pistol matches 1.. if items entity @s weapon.mainhand carrot_on_a_stick[custom_data={ziwagun:1}] run function ziwa:pistol/main
execute as @a if score @s gtime matches 0 if items entity @s weapon.offhand carrot_on_a_stick[custom_data={ziwagun:1}] unless score @s mag_pistol matches ..0 unless score @s ammo_pistol matches 12.. run function ziwa:pistol/reload
...
# mp
execute as @a if score @s gtime matches 0 if entity @s[advancements={rclick=true}] if score @s ammo_mp matches 1.. if items entity @s weapon.mainhand crossbow[custom_data={ziwagun:2}] run function ziwa:mp/main
execute as @a if score @s gtime matches 0 if items entity @s weapon.offhand crossbow[custom_data={ziwagun:2}] unless score @s mag_mp matches ..0 unless score @s ammo_mp matches 30.. run function ziwa:mp/reload
...
# shot
execute as @a if score @s gtime matches 0 if score @s rclick matches 1.. if score @s ammo_shot matches 1.. if items entity @s weapon.mainhand carrot_on_a_stick[custom_data={ziwagun:3}] run function ziwa:shot/main
execute as @a if score @s gtime matches 0 if items entity @s weapon.offhand carrot_on_a_stick[custom_data={ziwagun:3}] unless score @s mag_shot matches ..0 unless score @s ammo_shot matches 8.. run function ziwa:shot/reload
...
#sniper
execute as @a if score @s gtime matches 0 if items entity @s weapon.offhand spyglass[custom_data={ziwagun:5}] unless score @s ammo_sniper matches ..0 run function ziwa:sniper/main
...
execute as @a if entity @s[advancements={rclick=true}] run advancement revoke @s only rclick
...
execute as @a run clear @s arrow[custom_data={ziwaammo:-1}]
execute as @a run item replace entity @s inventory.0 with arrow[tooltip_display={hide_tooltip:true},custom_data={ziwaammo:-1}]